...
@ItemRegister(name = "createLand")
public class ItemCreateLand extends Item {
    @Override
    public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn,
        ...
        createCircle(pos, worldIn, 2, random);
        createCircle(pos.add(0, 1, 0), worldIn, 4, random);
        createCircle(pos.add(0, 2, 0), worldIn, 6, random);
        List<BlockPos> list = createLast(pos.add(0, 3, 0), worldIn, 7, random);
        createLake(pos.add(0, 5, 0), worldIn, 3, random, list);
